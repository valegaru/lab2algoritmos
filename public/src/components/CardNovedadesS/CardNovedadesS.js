class CardNovedadesSmall extends HTMLElement {
	constructor() {
		super();
	...
	render() {
		this.shadowRoot.innerHTML = `
          <link rel='stylesheet' href='./src/components/CardNovedadesS/CardNovedadesS.css'></link>
...
customElements.define('card-novedades-s', CardNovedadesSmall);
export default CardNovedadesSmall;
